...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_ellipse = QtWidgets.QPushButton(self.groupBox_2)
        self.btn_ellipse.setEnabled(True)
        self.btn_ellipse.setObjectName("btn_ellipse")
        self.gridLayout_4.addWidget(self.btn_ellipse, 0, 0, 1, 1)
        self.btn_lasso = QtWidgets.QPushButton(self.groupBox_2)
        self.btn_lasso.setObjectName("btn_lasso")
        self.gridLayout_4.addWidget(self.btn_lasso, 1, 0, 1, 1)
        self.btn_polygon = QtWidgets.QPushButton(self.groupBox_2)
        self.btn_polygon.setObjectName("btn_polygon")
        self.gridLayout_4.addWidget(self.btn_polygon, 2, 0, 1, 1)
        self.btn_retangle = QtWidgets.QPushButton(self.groupBox_2)
        self.btn_retangle.setObjectName("btn_retangle")
        self.gridLayout_4.addWidget(self.btn_retangle, 3, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_ellipse.setText(_translate("MainWindow", "Ellipse Selector"))
        self.btn_lasso.setText(_translate("MainWindow", "Lasso Selector"))
        self.btn_polygon.setText(_translate("MainWindow", "Polygon Selector"))
        self.btn_retangle.setText(_translate("MainWindow", "Rectangle Selector"))
